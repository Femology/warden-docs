...
- **[warden-contract](https://github.com/wardenoss/warden-contract/blob/main/CONTRIBUTING.md)** -- Rust / Soroban. The policy engine itself.
- **[warden-sdk](https://github.com/wardenoss/warden-sdk/blob/main/CONTRIBUTING.md)** -- TypeScript. The client library, never signs anything.
- **[warden-app](https://github.com/wardenoss/warden-app/blob/main/CONTRIBUTING.md)** -- Next.js. The reference wallet, passkey-signed.
- **[warden-monitor](https://github.com/wardenoss/warden-monitor/blob/main/CONTRIBUTING.md)** -- Node + Next.js. Read-only observability.
...
- [warden-contract#3](https://github.com/wardenoss/warden-contract/issues/3): the
  velocity window's fixed-reset limitation, described on
  [Protocol mechanics](protocol-mechanics.md).
- [warden-app#2](https://github.com/wardenoss/warden-app/issues/2): deploying
  `warden-app` to a real public URL.
- [warden-monitor#2](https://github.com/wardenoss/warden-monitor/issues/2) and
  [#3](https://github.com/wardenoss/warden-monitor/issues/3): deploying the indexer and
  dashboard.
...
[warden-contract](https://github.com/wardenoss/warden-contract/blob/main/SECURITY.md) ·
[warden-sdk](https://github.com/wardenoss/warden-sdk/blob/main/SECURITY.md) ·
[warden-app](https://github.com/wardenoss/warden-app/blob/main/SECURITY.md) ·
[warden-monitor](https://github.com/wardenoss/warden-monitor/blob/main/SECURITY.md).
